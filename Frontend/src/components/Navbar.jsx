...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex justify-between items-center px-4 py-2 mb-10 shadow-md bg-red-500">
      <h1
      ...
      <div className="flex space-x-4 items-center">
        ...
        {!user ? (
          <button
            ...
            className="px-4 py-1 bg-white hover:bg-black text-red-500 font-bold"
          >
            Sign In/Signup
          </button>
        ) : (
