...
function App() {
  ...
  return (
    <main>
        ...
        <Route
          ...
          element={
            <>
              ...
              <p className="text-black"	>"YOU HAVE TO LOGIN TO SAVE YOUR ADDRESS"</p>
                <h1
                  className="py-1 self-end px-4 text-blue-700 mb-4 w-max border-b cursor-pointer hover:border-blue-500 "
      ...
      {/* footer */}
      <footer className="flex bg-red-600 z-10 fixed bottom-0 w-full space-x-4 border-t justify-center py-4">
        <a
